    ...
    public static class LocalizationService
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
        {
            ...
            ["es"] = new Dictionary<string, string>
            {
                ...
                ["AnalyticsDashboardDesc"] = "Métricas y recomendaciones inteligentes",
                ...
                ["GitHubLoginError"] = "Error al iniciar sesión con GitHub",
                ["LoginCanceled"] = "Inicio de sesión cancelado",
                ["NoEmailFromGoogle"] = "No se pudo obtener el email de Google",
                ["NoAuthorizationCode"] = "No se recibió código de autorización",
                ["NoAccessToken"] = "No se pudo obtener el token de acceso",
                ["NoUserInfo"] = "No se pudo obtener la información del usuario",
                ["NetworkError"] = "Error de conexión. Verifica tu conexión a internet.",
                ["InvalidAccount"] = "Cuenta inválida",
                ["InternalError"] = "Error interno de autenticación",
                ["UnexpectedError"] = "Error inesperado al iniciar sesión",
                ["AccountLinked"] = "Cuenta vinculada exitosamente",
                ["AccountAlreadyLinked"] = "Esta cuenta social ya está vinculada a otro usuario",
                ["PasswordSet"] = "Contraseña establecida exitosamente",
                ["SocialLoginProfile"] = "Perfil de login social",
                ["LinkAccount"] = "Vincular cuenta",
                ["SetPassword"] = "Establecer contraseña",
                ["ProfilePicture"] = "Foto de perfil",
                ["AuthProvider"] = "Método de autenticación",
            ...
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["AnalyticsDashboard"] = "Analytics Dashboard",
                ["AnalyticsDashboardDesc"] = "Metrics and intelligent recommendations",
                ...
                ["ConnectingGitHub"] = "Connecting with GitHub...",
                ...
                ["NoEmailFromGoogle"] = "Could not retrieve email from Google",
                ["NoAuthorizationCode"] = "No authorization code received",
                ["NoAccessToken"] = "Could not obtain access token",
                ...
                ["AccountAlreadyLinked"] = "This social account is already linked to another user",
                ["PasswordSet"] = "Password set successfully",
                ["SocialLoginProfile"] = "Social login profile",
